 ...
 * @param dataRecipient The object that will receive the data that is streamed from the daqDevice.  The @c dataRecipient object's @c receiveData: method will be called each time new data is streamed from the daqDevice.
 * @return @c An initialised @c DRHSamplingOperation.
 */
-(DRHSamplingOperation *)initSamplingOperationWith:(DRHDaqDevice *)newDaqDevice And:(id)dataRecipient;
 ...
 */
+(DRHSamplingOperation *)samplingOperationWith:(DRHDaqDevice *)newDaqDevice And:(id)dataRecipient;
