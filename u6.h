...
//u6.c was authored by LabJack and is provided as part of the exodriver exapmles.  However, I have modified the file to remove implicit conversion compiler warnings.  - Lee Walsh.
...
#include <math.h>
#include <stdlib.h>
#include "/usr/local/include/labjackusb.h"
